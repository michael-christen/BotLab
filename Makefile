...
../../bin/maebot_app: maebot_app.o gui.o disjoint.o blob_detection.o calibration.o odometry.o barrel_distortion.o drive_ctrl.o pid_ctrl.o grid_map.o image.o line_detection.o mapping.o
